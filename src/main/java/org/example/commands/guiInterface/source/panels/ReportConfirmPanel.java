...
public class ReportConfirmPanel
{
    private final ButtomCreator buttonCreator;

    public ReportConfirmPanel(ButtomCreator buttonCreator)
    {
    ...
    public void open(Player player)
    {
        ...
        inventory.setItem(11, buttonCreator.createButton(Material.LIME_WOOL, ChatColor.GREEN + "Take case"));
        inventory.setItem(15, buttonCreator.createButton(Material.RED_WOOL, ChatColor.RED + "Cancel"));
